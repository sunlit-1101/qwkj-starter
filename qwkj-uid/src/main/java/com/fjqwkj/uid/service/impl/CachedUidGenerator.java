 ...
 */
package com.fjqwkj.uid.service.impl;

import com.fjqwkj.uid.buffer.BufferPaddingExecutor;
import com.fjqwkj.uid.buffer.RejectedPutBufferHandler;
import com.fjqwkj.uid.buffer.RejectedTakeBufferHandler;
import com.fjqwkj.uid.buffer.RingBuffer;
import com.fjqwkj.uid.common.exception.UidGenerateException;
import com.fjqwkj.uid.worker.WorkerIdAssigner;
import com.fjqwkj.uid.common.utils.BitsAllocator;
...
public class CachedUidGenerator extends DefaultUidGenerator implements DisposableBean {
    ...
    public String parseUID(long uid) {
        LOGGER.warn("使用缓存RingBuffer,ID为预生成的,解析出的ID生成时间并不能代表记录产生的真实时间");
